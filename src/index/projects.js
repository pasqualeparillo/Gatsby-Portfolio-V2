    ...
    >
      ...
      <div className="pt-6 lg:pl-10 lg:pr-10 pl-6 pr-6 w-full">
        <div className="w-full flex flex-wrap ">
          <div className="w-full flex flex-wrap justify-start">
            <div className="w-1/2 flex justify-start">
              <p className="font-black uppercase leading-none tracking-tighter py-2">
                Project:
              </p>
            </div>
            <div className="w-1/2 flex justify-start">
              <p className="uppercase leading-none tracking-tighter py-2">
                Devrebase
              </p>
            </div>
          </div>
        ...
        <div className="h-32 lg:w-3/4 w-full">
          <p className="leading-normal tracking-tighter ">
            Job board for developers by a developer
          </p>
        </div>
        <motion.div
          className="h-10 "
