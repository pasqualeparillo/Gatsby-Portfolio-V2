		...
		<div className="flex flex-wrap flex-grow relative lg:flex-row">
			<div className="lg:w-3/5 w-full lg:h-full h-64 lg:border-b-0 border-b border-black">
				<motion.div variants={parent} className="w-full h-full flex flex-wrap relative">
					<div className="flex flex-col justify-center w-full items-start relative overflow-hidden p-1 font-bebas">
						<motion.p
							className="font-black tracking-widest uppercase absolute z-20 text-blue-800 lg:text-9vw md:text-13vw text-18vw"
							style={{
								lineHeight: 0.9,
